    ...
    public Jogo() {
        ...
        public void Jogar() throws InterruptedException {
            ...
            while(rodada_atual <= this.rodadas) {
                ui.mostrarRodadaAtual(rodada_atual);
                ...
                var vencedor = verifica_vencedor(pontuacao1, pontuacao2);
                TimeUnit.SECONDS.sleep(1);
                ui.mostra_vencedor(vencedor);
                if(rodada_atual == this.rodadas){
                    ui.mostrarPontuacaoGeral(this.jogador1.getPontos(), this.jogador2.getPontos());
                }
                rodada_atual++;
                cont += 1;
        ...
        private int verifica_vencedor(int pontuacao_jogador1, int pontuacao_jogador2){
            if(pontuacao_jogador1 > 21){
                if(pontuacao_jogador2 == 21){
                    ...
                    ui.mostrarPontuacaoRodada(0, 30);
                    return 2;
                    ...
                    //perdedor
                    this.jogador1.mudarPontos((-5));
                    ui.mostrarPontuacaoRodada(-5, pontuacao_jogador2);
                    return 2;
                }
                else //os dois estouraram
                {
                    ...
                    ui.mostrarPontuacaoRodada(pontuacao_jogador1-21, pontuacao_jogador2-21);
                    return 0;
                }
            }
            else if (pontuacao_jogador2 > 21) {
                if(pontuacao_jogador1 == 21){
                    ...
                    ui.mostrarPontuacaoRodada(30, 0);
                } else{
                    this.jogador1.mudarPontos(pontuacao_jogador1);
                    ui.mostrarPontuacaoRodada(pontuacao_jogador1, 0);
                }
                return 1;
            }
                ...
                if(pontuacao_jogador1 == 21){
                    ...
                    ui.mostrarPontuacaoRodada(pontuacao_jogador1-pontuacao_jogador2, 0);
                }
                return 1;
            }
                ...
                if(pontuacao_jogador2 == 21){
                    ...
                    this.jogador2.mudarPontos(pontuacao_jogador2-pontuacao_jogador1);
                    ui.mostrarPontuacaoRodada(0, pontuacao_jogador2-pontuacao_jogador1);
                }
                return 2;
            }
            else {
                ...
                ui.mostrarPontuacaoRodada(10, 10);
